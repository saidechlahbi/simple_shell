...
/**
 * _str_duplicate - duplicates an string
...
char *_str_concat(char *string1, char *string2)
{
	...
	if (string1 == NULL)
		string1 = "";
	length1 = _str_length(string1);

	if (string2 == NULL)
		string2 = "";
	length2 = _str_length(string2);
...
void _str_reverse(char *string)
{
	...
	int i = 0, length = _str_length(string) - 1;
	char hold;
